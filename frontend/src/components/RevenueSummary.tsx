...
export const RevenueSummary: React.FC<RevenueSummaryProps> = ({ propertyId = 'prop-001', debugTenant, showRaw }) => {
    ...
    const displayTotal = Number.isFinite(totalRevenue) ? totalRevenue : 0;
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
            ...
            <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                            Reporting period: {data.month.toString().padStart(2, '0')}/{data.year} ({data.timezone})
                        </p>
                ...
                <div className="mt-4 h-6">
                    {data.total_revenue.includes('.') && data.total_revenue.split('.')[1]?.length > 2 && showRaw && (
